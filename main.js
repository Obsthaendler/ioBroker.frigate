...
class Frigate extends utils.Adapter {
    ...
    async onEventChange(obj) {
        ...
        const after = extractedJSON.after;
        ...
        const bsnap = after + '.has_snap'; // after or beforce, i dont know what is better // = await this.getStateAsync(beforecamera + '.snapshots.state');
        const bclip = after + '.has_clip'; // await this.getStateAsync(beforecamera + '.recordings.state');
